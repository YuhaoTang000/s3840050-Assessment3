...
public abstract class AbstractVehicle implements Vehicle {
	...
	public static void isValidRego(String rego) {
		if (Character.isDigit(rego.charAt(0)) || Character.isDigit(rego.charAt(4)) || Character.isDigit(rego.charAt(5))
				|| !Character.isUpperCase(rego.charAt(0)) || !Character.isUpperCase(rego.charAt(4))
				|| !Character.isUpperCase(rego.charAt(5))) {
			new IllegalRegistrationException("Uppercase character expected.");
		} else if (!Character.isDigit(rego.charAt(1)) || !Character.isDigit(rego.charAt(2))
				|| !Character.isDigit(rego.charAt(3))) {
	...
	public String toString() {
		return (rego + ";" + year + ";" + make + ";" + model + ";" + maintenance.getOdometer() + ";"
				+ maintenance.getOdometerWhenLastServiced() + ";" + maintenance.getOdometerServiceInterval());
	}
